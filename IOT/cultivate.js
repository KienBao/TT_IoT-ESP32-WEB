...
//autoupdate imglight
database.ref("/cultivate/Den_1").on("value", function(snapshot){
    var ss = snapshot.val();
    if(ss == 'on'){
...
//autoupdate imglight
database.ref("/cultivate/Den_2").on("value", function(snapshot){
    var ss = snapshot.val();
    if(ss == 'on'){
...
//autoupdate imglight
database.ref("/cultivate/Den_3").on("value", function(snapshot){
    var ss = snapshot.val();
    if(ss == 'on'){
...
//autoupdate imglight
database.ref("/cultivate/Den_4").on("value", function(snapshot){
    var ss = snapshot.val();
    if(ss == 'on'){
       document.getElementById('imgFanCtl4').src="LightOn.png";
...
database.ref("/cultivate/Nhietdo1").on("value", function(snapshot){
    var temp = snapshot.val();
    document.getElementById("nhietdo1").innerHTML = temp
});

database.ref("/cultivate/Nhietdo2").on("value", function(snapshot){
    var temp = snapshot.val();
    document.getElementById("nhietdo2").innerHTML = temp
});

database.ref("/cultivate/doam1").on("value", function(snapshot){
    var temp = snapshot.val();
    document.getElementById("doam1").innerHTML = temp
});

database.ref("/cultivate/doam2").on("value", function(snapshot){
    var temp = snapshot.val();
